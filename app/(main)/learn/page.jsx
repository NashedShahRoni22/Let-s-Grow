...
export default function LearnPage() {
  ...
  const stats = [
    { icon: Users, label: "Active Investors", value: "15,000+", color: "text-blue-400" },
    { icon: DollarSign, label: "Capital Deployed", value: "$50M+", color: "text-emerald-400" },
    { icon: Target, label: "Success Rate", value: "94%", color: "text-purple-400" },
    { icon: Clock, label: "Avg. Return Time", value: "45 Days", color: "text-pink-400" },
  ];
  ...
  return (
    <div className="bg-slate-900 text-white overflow-hidden">
      ...
      {/* <div className="fixed inset-0 opacity-20">
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-gray-900 to-emerald-950"></div>
      ...
      <section className="relative px-6 md:px-12 lg:px-20 py-32 text-center overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="inline-flex items-center px-6 py-3 bg-blue-500/20 rounded-full border border-blue-500/30 mb-8 backdrop-blur-sm">
            <Zap className="h-5 w-5 text-blue-400 mr-2" />
            <span className="text-blue-300 font-medium">Smart Investment Platform</span>
          </div>
          
          <h1 className="text-5xl md:text-7xl font-bold mb-8 bg-gradient-to-r from-white via-blue-200 to-white bg-clip-text text-transparent leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
            <button className="group px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full font-semibold text-lg hover:shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 transform hover:scale-105">
              Start Investing Now
              <ArrowRight className="inline-block ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
            </button>
            <button className="px-8 py-4 border-2 border-blue-500/50 rounded-full font-semibold text-lg hover:bg-blue-500/10 transition-all duration-300">
              Watch Demo
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((step, idx) => (
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-2xl blur opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                
                <div className="relative bg-black/40 backdrop-blur-sm p-8 rounded-2xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300">
                  ...
                  <p className="text-blue-400 font-medium text-sm">{step.detail}</p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {benefits.map((benefit, idx) => (
              <div
                key={idx}
                className="group relative overflow-hidden bg-black/30 backdrop-blur-sm p-8 rounded-2xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 hover:transform hover:scale-105"
              >
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-500/10 to-transparent rounded-full -mr-16 -mt-16 transition-all duration-300 group-hover:scale-150"></div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg">
              We've got answers. Here's what investors ask us most.
            </p>
          </div>
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              <div
                key={idx}
                className="bg-gray-800/30 backdrop-blur-sm rounded-2xl border border-blue-500/10 hover:border-blue-500/30 transition-all duration-300 overflow-hidden"
              >
                <button
                  className="w-full p-6 text-left flex items-center justify-between hover:bg-blue-500/5 transition-all duration-300"
                  onClick={() => setOpenFaq(openFaq === idx ? null : idx)}
                >
                  <span className="font-semibold text-lg text-blue-300 pr-4">{faq.q}</span>
                  <ChevronDown
      ...
      <section className="py-24 px-6 md:px-12 lg:px-20">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <Star className="h-12 w-12 text-blue-400 mx-auto mb-4 animate-pulse" />
            <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <button className="group px-12 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full font-semibold text-lg hover:shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 transform hover:scale-105">
              Start Investing Today
              <ArrowRight className="inline-block ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
            </button>
            <button className="px-12 py-4 border-2 border-blue-500/50 rounded-full font-semibold text-lg hover:bg-blue-500/10 transition-all duration-300">
              Schedule a Call
            </button>
          </div>
